  ...
  return (
    <>
      <div className="mb-4">
        ...
        >
          <div className="text-xs font-bold uppercase leading-[14.4px] text-neutral-900 md:!text-base md:font-medium md:!leading-[19.2px] select-none md:select-text">
            Price Details
          </div>
        </div>
        <div className="xs:!hide-scrollbar xs:border-1 border-[#eae9ef] monts border-x xs:border-divider">
          <div>
            <div className="flex items-center justify-between px-4 py-3 font-normal !leading-[18px] md:px-6 md:text-sm md:!leading-[21px]">
              <p className="md:text-[10px] lg:text-xs xl:text-sm flex items-center gap-2 text-xs font-normal leading-[18px] text-neutral-500 md:!leading-[21px] select-none md:select-text">
                Total MRP{" "}
              </p>
              <div className="md:text-[10px] lg:text-xs xl:text-sm text-xs font-medium leading-[18px] text-blackSS md:!leading-[21px] select-none md:select-text">
          ...
          <div>
            <div className="flex items-center justify-between bg-burntCoralLight border-[#eae9ef] mt-1.5 px-4 py-2 !leading-[21px] md:px-6 xs:text-xs xs:font-medium xs:leading-[18px]">
              <div className="text-[8px] md:text-[10px] text-[12px] lg:text-xs xl:text-sm font-medium text-red-700 xs:text-xs xs:font-medium xs:leading-[18px] select-none md:select-text">
                Your Total Savings
              </div>
              <div className="text-[8px] md:text-[10px] lg:text-xs text-[12px] xl:text-sm font-medium text-red-700 xs:text-xs xs:font-medium xs:leading-[18px] select-none md:select-text">
                ₹ {totalPrice?.totalDis?.toLocaleString()}
              </div>
            </div>
          </div>
        ...
        <div className="fixed bottom-0 left-0 bottom-0 w-full z-10">
          <div
